    ...
    <footer class="relative bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100 text-gray-800 dark:text-[#111827]">
        ...
        <div class="absolute top-0 left-0 right-0 z-10">
            <svg viewBox="0 0 1440 100" class="w-full" preserveAspectRatio="none" style="height: 80px;">
                <path d="M0,100 C480,0 960,0 1440,100 L1440,0 L0,0 Z" fill="rgb(255, 255, 255)" class="dark:fill-gray-900"></path>
            </svg>
        </div>
            ...
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex justify-center space-x-5 md:justify-start">
                        <!-- Instagram -->
                        <a
                            v-if="footerSettings.instagram_url"
                        ...
                        <!-- Facebook -->
                        <a
                            v-if="footerSettings.facebook_url"
                        ...
                        <!-- TikTok -->
                        <a
                            v-if="footerSettings.tiktok_url"
                        ...
                        <!-- YouTube -->
                        <a
                            v-if="footerSettings.youtube_url"
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-gray-700 dark:text-[#111827]">
                        ...
                        <li v-if="footerSettings.contact_email" class="flex items-start">
                            <svg class="mr-2 mt-0.5 h-5 w-5 flex-shrink-0 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span>{{ footerSettings.contact_email }}</span>
                        </li>
                        <li v-if="footerSettings.contact_address" class="flex items-start">
                            <svg class="mr-2 mt-0.5 h-5 w-5 flex-shrink-0 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
